...
categories:
  ...
  - id: productivity
    ...
    priority: 300
    definition: "General office, knowledge-work, communication, collaboration, document editing, note-taking, and workflow coordination software."
    includes:
      - "Office"
      - "Xmind"
      - "Notion"
  ...
  - id: system_utilities
    ...
    priority: 500
    definition: "System enhancement, maintenance, diagnostics, archiving, device management, and utility tools."
    includes:
      - "Everything"
      - "7-Zip"
      - "Snipaste"
  ...
  - id: games_entertain
    ...
    priority: 600
    definition: "Game clients, launchers, entertainment platforms, and content consumption hubs."
    includes:
      - "Steam"
      - "Epic"
      - "Music Client"
